                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 p-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="marca" class="form-control" id="marca" placeholder="name@example.com">
                                    </div>
                                </div>
                                <div class="col-md-6 p-4">
                                    <div class="form-group">
                                        <label for="numero-de-serie" class="form-control-label">Numero de serie</label>
                                        <input type="text" name="numero_serie" class="form-control" id="numero-de-serie" placeholder="name@example.com">
                                    </div>
                                </div>
                                <div class="col-md-6 p-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6 p-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="fecha_garantia" value={{ now() }} type="date" id="fecha-de-vencimiento-garantia">
                                    </div>
                                </div>
                            </div>
